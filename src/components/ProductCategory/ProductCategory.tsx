...
const ProductCategory = () => {
	...
	const products: Product[] = [
		// Trending Products
		{
			...
			price: 15000,
			image: 'products/BukuMTKKelas10.jpg',
			category: 'akademis',
		...
		},
		{
			...
			price: 45000,
			image: 'products/SeragamSMAPutihAbu.png',
			category: 'seragam',
		...
		},
		{
			...
			price: 35000,
			image: 'products/KalkulatorScientific.jpg',
			category: 'akademis',
		...
		},
		{
			...
			price: 120000,
			image: 'products/GitarAkustikYamaha.jpg',
		...
		// Regular Products - Akademis
		{
			...
			price: 18000,
			image: 'products/BukuFisikaSMA.jpg',
			category: 'akademis',
			seller: 'MAN Insan Cendekia OKI',
			stock: 10,
			condition: '85%',
			description: 'Erlangga Kelas X, kondisi baik 85%'
		},
		{
			id: '2',
			title: 'Atlas Indonesia',
			price: 12000,
			image: 'products/AtlasIndonesia.jpg',
			category: 'akademis',
			seller: 'SMAN 1 Jakarta',
			stock: 8,
			condition: '90%',
		...
		// Seragam
		{
			...
			price: 40000,
			image: 'products/SeragamPramuka.jpg',
			category: 'seragam',
			seller: 'SMAN 1 Jakarta',
			stock: 4,
			condition: 'Baik',
		...
		},
		{
			...
			title: 'Baju Olahraga',
			price: 30000,
			image: 'products/BajuOlahraga.jpg',
			category: 'seragam',
		...
		// Ekstrakurikuler
		{
			...
			price: 85000,
			image: 'products/PianikaYamaha.jpg',
			category: 'ekstrakurikuler',
			seller: 'SMAN 1 Medan',
			stock: 5,
			condition: 'Baik',
