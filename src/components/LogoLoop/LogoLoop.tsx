...
const rootClassName = useMemo(() => {
	// build classes using CSS module tokens; keep passed className (global) if provided
	const classes: Array<string> = [];
	classes.push(styles.logoloop);
	classes.push(isVertical ? styles['logoloop--vertical'] : styles['logoloop--horizontal']);
...
return (
	<div ref={containerRef} className={rootClassName} style={containerStyle} role="region" aria-label={ariaLabel}>
		<div className={styles.logoloop__track} ref={trackRef} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
			{logoLists}
		</div>
	</div>
);
